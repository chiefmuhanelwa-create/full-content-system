...
export default function LandingPage() {
  return (
    <div className="min-h-screen font-display" style={{ background: '#FAFAFA' }}>
      ...
      {/* Nav */}
      <header className="fixed top-0 left-0 right-0 z-50" style={{ background: 'rgba(255,255,255,0.92)', backdropFilter: 'blur(12px)', borderBottom: '1px solid #E9E5F5' }}>
        <div className="max-w-6xl mx-auto px-6 h-14 flex items-center justify-between">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg flex items-center justify-center" style={{ background: '#1A1523' }}>
              <span className="font-display font-black text-xs" style={{ color: '#FFFFFF' }}>N</span>
            </div>
            <span className="font-display font-black text-[15px] tracking-tight" style={{ color: '#1A1523' }}>NOCHILL</span>
          </div>
          <nav className="hidden md:flex items-center gap-8">
            <a href="#tools" className="text-sm font-display font-medium transition-colors text-[#6B6480] hover:text-[#1A1523]">Tools</a>
            <a href="#frameworks" className="text-sm font-display font-medium transition-colors text-[#6B6480] hover:text-[#1A1523]">Frameworks</a>
            <a href="#proof" className="text-sm font-display font-medium transition-colors text-[#6B6480] hover:text-[#1A1523]">Proof</a>
          </nav>
          <div className="flex items-center gap-3">
            <Link href="/auth/signin" className="text-sm font-display font-semibold text-[#6B6480] hover:text-[#1A1523] transition-colors hidden sm:block">
              Sign in
            </Link>
        ...
        <div className="relative py-16">
          ...
          <div className="absolute top-4 left-0 w-52 rounded-2xl p-4 -rotate-2 z-20 hidden lg:block hover:-rotate-1 transition-transform duration-300"
            ...
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <span className="text-[10px] font-display font-bold uppercase tracking-wider" style={{ color: '#9B94AD' }}>Hook Generator</span>
            </div>
            <p className="text-[13px] font-display font-semibold leading-snug" style={{ color: '#1A1523' }}>
            ...
            <div className="mt-2.5 flex items-center gap-1.5">
              <span className="px-1.5 py-0.5 rounded text-[9px] font-display font-bold uppercase tracking-wider"
                style={{ background: 'rgba(139,92,246,0.08)', color: '#8B5CF6', border: '1px solid rgba(139,92,246,0.2)' }}>R×A×C×U^B</span>
              <span className="px-1.5 py-0.5 rounded text-[9px] font-display font-bold uppercase tracking-wider"
          ...
          <div className="absolute top-2 right-0 w-56 rounded-2xl p-4 rotate-2 z-20 hidden lg:block hover:rotate-1 transition-transform duration-300"
            ...
            <div className="flex items-center gap-2 mb-2.5">
              ...
              <span className="text-[10px] font-display font-bold uppercase tracking-wider" style={{ color: '#9B94AD' }}>Proof Story · S004</span>
            </div>
            <div className="text-2xl font-display font-black leading-none" style={{ color: '#1A1523' }}>R50,000</div>
            <p className="text-[11px] mt-1 font-display leading-relaxed" style={{ color: '#6B6480' }}>April 2020 — standing rate R15,000. Costed the work. Quoted R45,000.</p>
            <div className="mt-2.5 h-1.5 rounded-full" style={{ background: '#F5F3FF' }}>
              <div className="h-full w-4/5 rounded-full" style={{ background: '#8B5CF6' }} />
            </div>
          </div>
          ...
          <div className="absolute bottom-4 left-2 w-60 rounded-2xl p-4 rotate-1 z-20 hidden lg:block hover:rotate-0 transition-transform duration-300"
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[10px] font-display font-bold uppercase tracking-wider" style={{ color: '#9B94AD' }}>Today's Pipeline</span>
            </div>
            <div className="space-y-2">
              {[
                { label: 'Write 3 hooks', color: '#8B5CF6' },
                { label: 'Draft a script', color: '#A78BFA' },
                { label: 'Schedule 7 days', color: '#22c55e' },
              ].map((item) => (
                <div key={item.label} className="flex items-center gap-2">
                  <div className="w-1.5 h-1.5 rounded-full flex-shrink-0" style={{ background: item.color }} />
                  <span className="text-[12px] font-display" style={{ color: '#6B6480' }}>{item.label}</span>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="absolute bottom-6 right-2 w-52 rounded-2xl p-4 -rotate-1 z-20 hidden lg:block hover:rotate-0 transition-transform duration-300"
            ...
            <div className="flex items-center gap-2 mb-3">
              ...
              <span className="text-[10px] font-display font-bold uppercase tracking-wider" style={{ color: '#9B94AD' }}>Shadow Fears</span>
            </div>
            <div className="space-y-1.5">
              {['Invisible Labour', 'Platform Dependency', 'Time Anxiety'].map((fear) => (
                <div key={fear} className="flex items-center justify-between">
                  <span className="text-[11px] font-display" style={{ color: '#6B6480' }}>{fear}</span>
          ...
          <div className="rounded-3xl overflow-hidden relative flex flex-col items-center text-center px-8 py-24 md:py-32"
            ...
            <div className="relative z-10 max-w-2xl">
              <div className="inline-flex items-center gap-2 mb-7 px-3.5 py-1.5 rounded-full"
                ...
                <span className="font-display font-medium text-xs" style={{ color: '#6B6480' }}>AI-powered · NoChill frameworks · Built for SA creators</span>
              </div>
              <h1 className="font-display font-black leading-[0.92] tracking-tight mb-6">
                <span className="block" style={{ fontSize: 'clamp(52px, 7vw, 84px)', color: '#1A1523' }}>Create. Plan.</span>
                <span className="block" style={{ fontSize: 'clamp(52px, 7vw, 84px)', color: '#8B5CF6' }}>Sell more.</span>
              </h1>
              <p className="text-lg font-display font-normal mb-9 leading-relaxed max-w-lg mx-auto" style={{ color: '#6B6480' }}>
              ...
              <Link href="/auth/signin"
                ...
                style={{ background: '#1A1523', color: '#FFFFFF', boxShadow: '0 4px 16px rgba(0,0,0,0.18)' }}>
                Enter the System
      ...
      {/* Stats bar */}
      <section id="proof" className="py-10 px-6" style={{ borderTop: '1px solid #E9E5F5', borderBottom: '1px solid #E9E5F5', background: '#FFFFFF' }}>
        <div className="max-w-5xl mx-auto grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          {[
            ...
            <div key={stat.label}>
              <div className="text-3xl font-display font-black leading-none" style={{ color: '#1A1523' }}>{stat.value}</div>
              <div className="text-[13px] font-display mt-1.5" style={{ color: '#9B94AD' }}>{stat.label}</div>
            </div>
          ))}
        </div>
      </section>
      ...
      <section id="tools" className="py-20 px-6 max-w-5xl mx-auto">
        <div className="mb-10">
          <p className="font-display font-semibold text-xs uppercase tracking-widest mb-2" style={{ color: '#8B5CF6' }}>What's inside</p>
          <h2 className="text-[32px] font-display font-black leading-tight" style={{ color: '#1A1523' }}>45 tools. One system.</h2>
        </div>
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-3">
          {[
            { title: 'Hook Generator', desc: 'R×A×C×U^B Formula — verbal + visual hook pairs. Interest Peak targeting.', tag: 'CREATE', accent: '#8B5CF6' },
            { title: 'Script Writer', desc: '7-Act structure + 3 NOCHILL templates. R50 quality gate.', tag: 'CREATE', accent: '#A78BFA' },
            ...
            <div key={tool.title}
              className="rounded-xl p-5 transition-all cursor-default border border-[#E9E5F5] hover:shadow-md"
              ...
              <h3 className="font-display font-semibold text-[14px] mb-1.5" style={{ color: '#1A1523' }}>{tool.title}</h3>
              <p className="text-[13px] leading-relaxed font-display" style={{ color: '#6B6480' }}>{tool.desc}</p>
            </div>
          ))}
        </div>
      </section>
      ...
      {/* PAIDS */}
      <section id="frameworks" className="py-20 px-6" style={{ borderTop: '1px solid #E9E5F5', background: '#FFFFFF' }}>
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-10">
            <p className="font-display font-semibold text-xs uppercase tracking-widest mb-2" style={{ color: '#8B5CF6' }}>Revenue model</p>
            <h2 className="text-[28px] font-display font-black" style={{ color: '#1A1523' }}>PAIDS — 5 income streams</h2>
            <p className="font-display text-sm mt-2" style={{ color: '#6B6480' }}>Every rand you earn runs through one of these five channels.</p>
          </div>
          <div className="grid md:grid-cols-5 gap-3">
            {[
              ...
              <div key={stream.letter}
                className="rounded-xl p-5 text-center border border-[#E9E5F5] hover:border-[#8B5CF6]/40 hover:bg-white transition-all"
                style={{ background: '#FAFAFA' }}>
                <div className="w-9 h-9 rounded-xl flex items-center justify-center mx-auto mb-3" style={{ background: '#1A1523' }}>
                  <span className="font-display font-black text-sm" style={{ color: '#FFFFFF' }}>{stream.letter}</span>
                </div>
                <h3 className="font-display font-semibold mb-1 text-[13px]" style={{ color: '#1A1523' }}>{stream.label}</h3>
                <p className="text-xs leading-relaxed font-display" style={{ color: '#6B6480' }}>{stream.desc}</p>
              </div>
            ))}
          </div>
          <p className="text-center text-xs mt-6 font-display" style={{ color: '#D6CFEA' }}>
      ...
      <section className="py-20 px-6 relative overflow-hidden" style={{ background: '#FAFAFA' }}>
        ...
        <div className="max-w-xl mx-auto text-center relative">
          <div className="rounded-2xl p-12" style={{ background: '#FFFFFF', border: '1px solid #E9E5F5', boxShadow: '0 4px 32px rgba(0,0,0,0.06)' }}>
            ...
            <p className="font-display text-sm mb-8 leading-relaxed" style={{ color: '#6B6480' }}>
      ...
      {/* Footer */}
      <footer className="py-6 px-6" style={{ borderTop: '1px solid #E9E5F5', background: '#FFFFFF' }}>
        <div className="max-w-5xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-2">
            <div className="w-6 h-6 rounded-lg flex items-center justify-center" style={{ background: '#1A1523' }}>
              <span className="font-display font-black text-[10px]" style={{ color: '#FFFFFF' }}>N</span>
            </div>
            <span className="font-display font-semibold text-sm" style={{ color: '#9B94AD' }}>NOCHILL</span>
          </div>
          <p className="text-xs font-display" style={{ color: '#D6CFEA' }}>© 2026 NOCHILL PTY LTD (2016/507839/07)</p>
        </div>
      </footer>
    </div>
  )
