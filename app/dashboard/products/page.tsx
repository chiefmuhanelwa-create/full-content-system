    ...
    if (stored) {
      ...
      const defaultProducts: Product[] = [
        ...
        },
        {
          ...
          productType: 'Digital',
          status: 'Live',
          painPoints: 'Time-for-money trap, can\'t scale, missing systems for growth',
          coreBenefits: 'Complete business system, scalable frameworks, generational wealth foundation',
          description: 'Everything you need to transition from creator to contentpreneur. Full operating system.',
          bonuses: 'Private community access, Monthly group coaching, All templates and frameworks',
          priceAnchor: 'MBA costs R200,000+ and teaches theory. This is practical business building.',
          guarantee: 'Implement for 90 days or full refund',
          testimonials: 'Transformed 100+ creators into business owners',
          createdAt: new Date().toISOString(),
        },
      ]
