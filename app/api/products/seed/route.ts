...
const NOCHILL_PRODUCTS = [
  ...
  },
  {
    ...
    notes: 'SARS assessed R207,879.20. Filed amended returns. Penalties waived R45,705.06. Final paid R162,174.14. Teach every creator to avoid this.',
    tags: JSON.stringify({
      step1_callout: 'If you\'ve received any brand payment and haven\'t declared it to SARS — this is urgent. For you.',
      step2_attention: 'SARS assessed me R207,879 because nobody told me brand payments count as income. Filed amended returns. Got R45,705 in penalties waived. But I had to find the right accountant first.',
      ...
      step5_floodlight: 'R207,879 assessed. R45,705 in penalties waived. R162,174 final paid over 11 months. All because I had no creator tax system.',
      ...
      step7_credentials: 'I paid R162,174 to learn this. Plus R30,000 in professional fees. You\'re paying nothing. Use what I bought with my mistake.',
      ...
      step9_proof: 'R207,879 SARS assessment → R162,174 final paid (R45,705 penalties waived). Sleep without SARS anxiety.',
      step10_offer: 'Stop Being Scared of SARS — fix your creator tax the right way. Before it\'s too late.',
      contentHooks: [
        'SARS assessed me R207,879 because nobody told me brand payments were taxable income.',
        'Filed amended returns. SARS waived R45,705 in penalties. Here\'s the route nobody tells you about.',
        'SARS is watching your Payfast account. Your Instagram doesn\'t show them everything.',
        'The deductions list that protects creator income. Yours for under R300.',
