...
const PROOF_STORIES = [
  ...
  {
    storyKey: 'sars_r285k_debt',
    title: 'SARS R285K Tax Debt',
    snippet: "SARS came for me with a R285K bill. I didn't know how to run a business. That lesson cost me, but it taught me.",
    fullVersion: "When you go from struggling to making real money fast, nobody teaches you the business side. SARS came for me. R285,000. That number still makes me uncomfortable to say. But I say it because it is the exact reason I teach creators how to build a real business, not just a content career.",
    timeframe: '12-15s',
    emotion: 'Naive success → Painful lesson → Informed leadership',
    lesson: 'Making money and running a business are two different skills. Learn both.',
    useFor: JSON.stringify(['Business Building', 'Called Expert', 'Financial Literacy', 'Hard Lessons']),
    contentPillars: JSON.stringify(['education', 'story', 'authority']),
    beforeState: 'Making money without understanding tax and business structure',
    afterState: 'Built proper business systems, teaches others to avoid same mistake',
    specificNumbers: JSON.stringify({ tax_debt: 'R285,000' }),
    isSpecial: true, isRelevant: true, isQuantifiable: true, hasNames: true,
    villain: 'Financial illiteracy and ignoring business fundamentals',
    shadowFear: 'Fear of being exposed as bad with money',
    isFavorite: false,
    tags: JSON.stringify(['business', 'tax', 'financial-literacy', 'called-expert', 'hard-lessons']),
  },
  {
